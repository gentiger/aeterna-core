...
// 中央集水區叢林
export const FOREST = [[-5.5,-5.5],[-3,-7],[0,-7.5],[2.5,-6.5],[3.2,-3.5],[2,-0.5],[-0.5,0.4],[-3.5,-0.5],[-5.2,-3]];
// 紅樹林／沼澤海岸
...
export function isForest(x,z){ return pip(x,z,FOREST); }
